...
<body>
    ...
    <div class="khung">
                ...
                foreach ($rowDonHang as $row) { ?>
                    ...
                    <div class="dh-div2">
                        <div class="dh-div3">
                            ...
                            <p>Trạng thái: <span class="trangthai"><?php echo $row['trangthai']; ?></span></p>
                        </div>
                        <div class="dh-div4">
                            <a class="dh-div4-action2" id="action1" onclick="return dongdon();" href="index.php?action=ShipperDongDonHang&iddh=<?php echo $row['iddh']; ?>">Đóng đơn hàng</a>
                            <a class="dh-div4-action3" id="action2">Đơn hàng đã đóng</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
        ...
        <script>
            //action nhan don
            function dongdon() {
                return confirm("Xác nhận hoàn thành đơn hàng?");
            }
        </script>
        <!---->
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                const div1 = document.querySelectorAll(".dh-div2");

                div1.forEach(item => {
                    let bt1 = item.querySelector(".dh-div4-action2");
                    let bt2 = item.querySelector(".dh-div4-action3");
                    let trangthai = item.querySelector(".trangthai").textContent.trim();
                    let trangthaitext = item.querySelector(".trangthai");
                    //
