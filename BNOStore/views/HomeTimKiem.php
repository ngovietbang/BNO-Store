...
<body>
    ...
    <div class="khung">
        ...
        <div class="thongbao" id="thongbao">
            ...
            <p id="thongbao-text">dsadasdasdasd asdasdasd asdasdasd asdasdasd</p>
        </div>
        ...
        <div class="home-hien-thi-sp">
            ...
            <div class="sp-div1">
                ...
                if (!empty($rowSanPham)) { ?>
                    ...
                    <?php } ?>
                <?php } else {
                    echo "<p class='tb-tk'>Không tìm thấy sản phẩm ' " . $_GET['keyword'] . " ' </p>";
                }
                ?>
